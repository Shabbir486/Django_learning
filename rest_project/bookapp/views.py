...
# ModelSerializer Extra Concepts
...
class BookSerializerHyperlinked(APIView):
    class OutputSerializer(serializers.HyperlinkedModelSerializer):
        ...
        class Meta:
            ...
            # extra_kwargs = { Same thing we have to write here as above 'author' but all are in single inverted comma}
    ...
    def get(self,request):
        data = Book.objects.all()
        serializer = self.OutputSerializer(data, context={'request': 'GET'}, many=True)
        return Response(serializer.data)
